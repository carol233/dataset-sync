...
API_FEATURE = "G:/yanjie-data/RmvDroid_mal_api/"
OPCODE_FEATURE = "G:/yanjie-data/RmvDroid_mal_opseq/"
...
class Analysis:
    ...
    def save_result(self, request, res):
        ...
        if self.insert_count > 400:
            row = (res['opcode'], res['api'], res['condition'])
...
if __name__ == '__main__':
    ...
    analysis.add_database("rmvdroid", API_FEATURE)
    analysis.start()
